...
generatePopulationChart('chart_2013', 'line_2013', county_total_population_arr, county_old_population_arr);
generatePopulationChart('chart_2012', 'line_2012', county_total_population_arr_2012, county_old_population_arr_2012);
generatePopulationChart('chart_2011', 'line_2011', county_total_population_arr_2011, county_old_population_arr_2011);
...
$(document).ready(function() {
    ...
    $('rect,#county_tag').mouseover(function() {
        ...
        $('#box_2013 > p:nth-child(2) > map').text(Math.round(county_total_population_arr[rect_index]));
        $('#box_2013 > p:nth-child(4) > map').text(Math.round(county_old_population_arr[rect_index]));
